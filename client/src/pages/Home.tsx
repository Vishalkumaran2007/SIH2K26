...
const requirementChecklist: RequirementItem[] = [
  ...
  { id: "threat-intelligence", module: "07", title: "AbuseIPDB, VirusTotal, and PhishTank", detail: "AbuseIPDB and VirusTotal are available for separate analyst-approved public source-IP reputation checks and save provider evidence with the private case. PhishTank still needs approved provider access and is not connected.", status: "waiting", action: "intelligence" },
